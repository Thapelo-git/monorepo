...
# --- 1. CONFIGURATION ---
$PROJECT_NAME = "project1"  #match the name in your ECR repository without the "-api" suffix
$AWS_ACCOUNT_ID = "662896783891" # Your 12-digit AWS Account ID, should be on the top right conner, 
$AWS_REGION = "af-south-1"  # The AWS region where your ECR repository is located, e.g. us-east-1, us-west-2, etc.
