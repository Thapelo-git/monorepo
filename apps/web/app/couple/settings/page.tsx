      ...
      <main className="ml-64 flex-1">
        ...
        <div className="p-6 max-w-2xl">
          ...
          <div className="bg-white rounded-xl p-6 mb-6 border border-gray-100">
            <h2 className="font-serif text-xl text-gray-900 mb-4">Profile</h2>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-500">Alerts when budget threshold is exceeded</p>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
                    type="checkbox"
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-500">Receive chat messages and updates</p>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
                    type="checkbox"
          ...
          <div className="bg-white rounded-xl p-6 border border-gray-100">
            <h2 className="font-serif text-xl text-gray-900 mb-4">Appearance</h2>
            <div>
